  ...
  describe('Part II', function() {
    ...
    describe('contains', function() {
      ...
      it('should return false given an array and a value not in that array', function() {
        ...
        expect(_.contains([1, 2], 3)).to.be.false;
      });
    ...
    describe('every', function() {
      ...
      it('fails for a collection of all-falsy values', function() {
        // Replace this line with an `expect` statement that tests
        // the behavior described by the `it` string
        expect(_.every([1, 2, 5], isEven)).to.be.false;
      });
    ...
    describe('some', function() {
      ...
      it('should fail for a set containing no matching values', function() {
        // Replace this line with an `expect` statement that tests
        // the behavior described by the `it` string
        expect(_.some([1 === 2, 'yes' === 'no'], _.identity));
      });
    ...
    describe('extend', function() {
      ...
      it('should override properties found on the destination', function() {
        ...
        // the behavior described by the `it` string
        let destination = { a: 'b' };
        let source = { a: 'overridden' };
        let extended = _.extend(destination, source);

        expect(extended.a).to.equal('overridden');
      });
